...
<div class="container" id="profile">
  ...
  <center><h2><?php echo $pfname." ".$plname; ?></h2></center>

  <center><h4>Contact Number: <?php echo $pnumber; ?></h4></center><br>
  <center><h4>Email: <?php echo $pemail; ?></h4></center>

  <a href="settings.php"><center><button class="btn btn-info"> Edit Profile</button></center></a>
