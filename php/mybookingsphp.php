<?php
  ...
  $displaybooks = "";
  $sql = "SELECT * FROM book JOIN restaurants ON book.restaurantid = restaurants.restaurantid JOIN accounts ON book.accid = accounts.accid WHERE email = '".$pemail."' AND bookconfirmation = 'yes'";
  $result = mysqli_query($link, $sql);
  ...
  for($ctr = 0; $ctr < $noofbooks; $ctr = $ctr + 1)
  {
