<?php
  include 'php/bookingdetailsphp.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="form-inline" id="bread">
  <ul class="breadcrumb arr-right">
    <li class="breadcrumb-item"><a href="mybookings.php"><small>My Bookings</small></a></li>
    <li class="breadcrumb-item active"><small>Booking Details</small></li>
  </ul>
</div>
